...
import PugdagdInfoBox from './components/PugdagdInfoBox';
...
function Dashboard() {
  ...
  const [address, setAddress] = useState("pugdag:");
  ...
  return (
    <div className="align-pugdag-top">
        ...
        <Container className="firstRow webpage" fluid>
          <Row>
            <Col md={12} className='d-flex flex-row justify-content-start text-light d-xs-none align-items-center'>
              <img className="big-pugdag-icon" src="/k-icon-glow.png" />
            ...
            <Col xs={11}>
              <Form onSubmit={search}>
                <InputGroup className="ms-md-5 mt-5 me-5 dashboard-search-box">
                  <Form.Control className="bg-light text-dark shadow-none" name="searchInput" type="text" placeholder="Search for pugdag:address or block" />
      ...
      <div className="row2">
        <Container className="secondRow webpage" fluid>
          <Row>
            ...
            <Col sm={12} md={6} xl={3}><div className="infoBox"><PugdagdInfoBox /></div></Col>
