...
import { getCoinSupply, getHalving } from '../pugdag-api-client';
...
const CBox = () => {
    ...
    async function getBlockReward() {
        await fetch('https://api.pugdag.com/info/blockreward')
            ...
            <table style={{ fontSize: "1rem" }}>
                ...
                <tr>
                    <td className="cardBoxElement align-top">
                        Total</td>
                    <td className="">
                        <div id="coins">{numberWithCommas(circCoins)} PUG
                        </div>
                    </td>
                </tr>
                <tr>
                    <td className="cardBoxElement align-top">Max <span className="approx"></span></td>
                    <td className="pt-1">25,431,205,439 PUG</td>
                </tr>
                <tr>
                    <td className="cardBoxElement align-top">Mined</td>
                    <td className="pt-1">{(circCoins / 25431205439 * 100).toFixed(2)} %</td>
                </tr>
                <tr>
                    <td className="cardBoxElement align-top">Block reward</td>
                    <td className="pt-1">{blockReward} PUG</td>
                </tr>
                <tr>
                    ...
                    <td className="pt-1">{halvingDate}<br /><div className="text-end w-100 pe-3 pt-1" style={{ fontSize: "small" }}>to {halvingAmount} PUG</div></td>
                </tr>
            </table>
        </div>
    </>
